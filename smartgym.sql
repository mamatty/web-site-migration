...
INSERT INTO `exercise` VALUES ('6', 'Lat machine', 'Improvement of different muscular zones', 'Chest', 'https://www.youtube.com/watch?v=HtA6wD-3bDA');
INSERT INTO `exercise` VALUES ('7', 'Curl bilancere', 'Improvement of different muscular zones', 'Chest', 'https://www.youtube.com/watch?v=HtA6wD-3bDA');
INSERT INTO `exercise` VALUES ('8', 'Leg extension', 'Biceps development', 'Biceps', 'https://www.youtube.com/watch?v=fkbzIetmK-4');
INSERT INTO `exercise` VALUES ('9', 'Panca hyperextension', 'Improvement of different muscular zones', 'Chest', 'https://www.youtube.com/watch?v=HtA6wD-3bDA');
INSERT INTO `exercise` VALUES ('10', 'Shoulder press', 'Biceps development', 'Biceps', 'https://www.youtube.com/watch?v=fkbzIetmK-4');
...
CREATE TABLE `exercise_schedules` (
  ...
  CONSTRAINT `exercise_schedules_ibfk_2` FOREIGN KEY (`id_exercise`) REFERENCES `exercise` (`id_exercise`) ON DELETE CASCADE
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES ('1', 'Matteo', 'Novembre', 'matteo.novembre94@gmail.com', '$pbkdf2-sha256$29000$1RrDWAshRAiB8B7DeA8BQA$CwIk2vTctC6uwnTuUYI8xpN33rSKKqngcEaVpZVmc9M', '1994-08-06', 'Via Quarnaro I, n.41', '0', 'weekly', '2018-09-10');
INSERT INTO `user` VALUES ('2', 'Irene', 'Raimondi', 'ireraim@gmail.com', '$2y$10$.ahTbMa.wqeVje48mgYK1uJzwapMBXCSUxcb4qPuGo9NvUYm1fSRa', '1991-07-14', 'Via Monte Grappa 61', '0', 'weekly', '2018-09-10');
